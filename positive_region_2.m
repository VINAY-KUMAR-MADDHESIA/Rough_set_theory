function [POS_att , gamma_att] =  positive_region_2(decision_table , attribute_number , dec_attribute_number)
...
% (b) gamma_att = Gamma value of the particular attribute queried.
    ...
    IND_decision =  indisc_att_2(decision_table , dec_attribute_number) ;
